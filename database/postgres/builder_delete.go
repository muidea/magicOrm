...
func (s *Builder) BuildDelete(vModel model.Model) (ret builder.Result, err *cd.Error) {
...
func (s *Builder) BuildDeleteRelation(vModel model.Model, vField model.Field) (delHost, delRelation builder.Result, err *cd.Error) {
