...
func testSingleColumnIndexPerformance(t *testing.T, o1 orm.Orm, localProvider provider.Provider) {
	...
	nameFilter, err := localProvider.GetModelFilter(indexTestItemModel)
	if err != nil {
	...
	valueFilter, err := localProvider.GetModelFilter(indexTestItemModel)
	if err != nil {
		t.Errorf("GetModelFilter failed, err:%s", err.Error())
		return
	}
	...
	noIndexFilter, err := localProvider.GetModelFilter(indexTestItemModel)
	if err != nil {
		t.Errorf("GetModelFilter failed, err:%s", err.Error())
		return
	}
...
func testCompositeIndexPerformance(t *testing.T, o1 orm.Orm, localProvider provider.Provider) {
	...
	fullCompositeFilter, err := localProvider.GetModelFilter(indexTestItemModel)
	if err != nil {
		t.Errorf("GetModelFilter failed, err:%s", err.Error())
		return
	}
	...
	partialCompositeFilter, err := localProvider.GetModelFilter(indexTestItemModel)
	if err != nil {
		t.Errorf("GetModelFilter failed, err:%s", err.Error())
		return
	}
	...
	nonLeadingFilter, err := localProvider.GetModelFilter(indexTestItemModel)
	if err != nil {
		t.Errorf("GetModelFilter failed, err:%s", err.Error())
		return
	}
